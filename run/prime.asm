...
;3:	 Jump, -, -, l: 35
		jmp	@35
@4:
;4:	 -, Par[number, type int, offset 8, nest 0], 1, Temp[$17, type int, offset -2]
		mov	ax, word ptr [bp+8]
		mov	dx, 1
		sub	ax, dx
		mov	word ptr [bp-2], ax
;5:	 par, Temp[$17, type int, offset -2], V, -
		mov	ax, word ptr [bp-2]
		push	ax
;6:	 par, Temp[$18, type bool, offset -3], RET, -
...
;7:	 call, -, -, Fun[prime, index 32, params 2, vars 10, nest 0, parent _outer]
		...
		add	sp, 6
;8:	 ifb, Temp[$18, type bool, offset -3], -, l: 10
...
;11:	 call, -, -, Fun[incr, index 21, params 0, vars 0, nest 0, parent _outer]
		...
		call	near ptr _incr
		add	sp, 4
;12:	 -, Par[number, type int, offset 8, nest 0], 1, Temp[$19, type int, offset -5]
		mov	ax, word ptr [bp+8]
		mov	dx, 1
		sub	ax, dx
		mov	word ptr [bp-5], ax
;13:	 par, Temp[$19, type int, offset -5], V, -
...
;18:	 Jump, -, -, l: 32
		jmp	@32
@19:
;19:	 +, Par[number, type int, offset 8, nest 0], 1, Temp[$20, type int, offset -7]
		mov	ax, word ptr [bp+8]
		mov	dx, 1
		add	ax, dx
		mov	word ptr [bp-7], ax
;20:	 par, Temp[$20, type int, offset -7], V, -
		mov	ax, word ptr [bp-7]
		push	ax
;21:	 par, Temp[$21, type bool, offset -8], RET, -
		lea	si, byte ptr [bp-8]
		push	si
;22:	 call, -, -, Fun[prime, index 32, params 2, vars 10, nest 0, parent _outer]
		push	word ptr [bp+4]
		call	near ptr _p_prime_32
		add	sp, 6
;23:	 ifb, Temp[$21, type bool, offset -8], -, l: 25
...
;26:	 call, -, -, Fun[incr, index 21, params 0, vars 0, nest 0, parent _outer]
		...
		call	near ptr _incr
		add	sp, 4
;27:	 +, Par[number, type int, offset 8, nest 0], 1, Temp[$22, type int, offset -10]
		mov	ax, word ptr [bp+8]
		mov	dx, 1
		add	ax, dx
		mov	word ptr [bp-10], ax
;28:	 par, Temp[$22, type int, offset -10], V, -
...
;31:	 call, -, -, Fun[print_string, index 5, params 0, vars 0, nest 0, parent _outer]
		...
		add	sp, 4
@32:
;32:	 +, Par[number, type int, offset 8, nest 0], 6, Temp[$23, type int, offset -12]
		mov	ax, word ptr [bp+8]
		mov	dx, 6
		add	ax, dx
		mov	word ptr [bp-12], ax
;33:	 par, Temp[$23, type int, offset -12], V, -
...
;35:	 Endu, Fun[loop, index 34, params 2, vars 12, nest 0, parent _outer], -, -
		...
		ret
_p_loop_34	endp
;36:	 Unit, Fun[loop, index 33, params 2, vars 9, nest 1, parent prime], -, -
_p_loop_33	proc	near
		push	bp
		mov	bp, sp
		sub	sp, 9
;37:	 /, Par[n, type int, offset 8, nest 0], 2, Temp[$9, type int, offset -2]
		mov	si, word ptr [bp+4]
		...
		idiv	cx
		mov	word ptr [bp-2], ax
;38:	 <=, Par[i, type int, offset 8, nest 1], Temp[$9, type int, offset -2], l: 40
		mov	ax, word ptr [bp+8]
...
;39:	 Jump, -, -, l: 52
		jmp	@52
@40:
;40:	 Mod, Par[n, type int, offset 8, nest 0], Par[i, type int, offset 8, nest 1], Temp[$10, type int, offset -4]
		mov	si, word ptr [bp+4]
		mov	ax, word ptr [si+8]
		cwd
...
;41:	 =, Temp[$10, type int, offset -4], 0, l: 43
...
;42:	 Jump, -, -, l: 45
		jmp	@45
@43:
;43:	 :=, false, -, Temp[$11, type bool, offset -5]
		mov	al, 0
		mov	byte ptr [bp-5], al
;44:	 Jump, -, -, l: 50
		jmp	@50
@45:
;45:	 +, Par[i, type int, offset 8, nest 1], 2, Temp[$12, type int, offset -7]
		mov	ax, word ptr [bp+8]
		mov	dx, 2
		add	ax, dx
		mov	word ptr [bp-7], ax
;46:	 par, Temp[$12, type int, offset -7], V, -
		mov	ax, word ptr [bp-7]
		push	ax
;47:	 par, Temp[$13, type bool, offset -8], RET, -
		lea	si, byte ptr [bp-8]
		push	si
;48:	 call, -, -, Fun[loop, index 33, params 2, vars 9, nest 1, parent prime]
		push	word ptr [bp+4]
		call	near ptr _p_loop_33
		add	sp, 6
;49:	 :=, Temp[$13, type bool, offset -8], -, Temp[$11, type bool, offset -5]
		mov	al, byte ptr [bp-8]
		mov	byte ptr [bp-5], al
@50:
;50:	 :=, Temp[$11, type bool, offset -5], -, Temp[$14, type bool, offset -9]
		mov	al, byte ptr [bp-5]
		mov	byte ptr [bp-9], al
;51:	 Jump, -, -, l: 53
		jmp	@53
@52:
;52:	 :=, true, -, Temp[$14, type bool, offset -9]
		mov	al, 1
		mov	byte ptr [bp-9], al
@53:
;53:	 :=, Temp[$14, type bool, offset -9], -, $$
		mov	al, byte ptr [bp-9]
		mov	si, word ptr [bp+6]
		mov	byte ptr [si], al
;54:	 Endu, Fun[loop, index 33, params 2, vars 9, nest 1, parent prime], -, -
		mov	sp, bp
		pop	bp
		ret
_p_loop_33	endp
;55:	 Unit, Fun[prime, index 32, params 2, vars 10, nest 0, parent _outer], -, -
...
;60:	 par, Temp[$2, type bool, offset -3], RET, -
		lea	si, byte ptr [bp-3]
		push	si
;61:	 call, -, -, Fun[prime, index 32, params 2, vars 10, nest 0, parent _outer]
		push	word ptr [bp+4]
		call	near ptr _p_prime_32
		add	sp, 6
...
;77:	 par, 3, V, -
		mov	ax, 3
		push	ax
;78:	 par, Temp[$8, type bool, offset -10], RET, -
		lea	si, byte ptr [bp-10]
		push	si
;79:	 call, -, -, Fun[loop, index 33, params 2, vars 9, nest 1, parent prime]
		push	bp
		call	near ptr _p_loop_33
		add	sp, 6
;80:	 :=, Temp[$8, type bool, offset -10], -, Temp[$7, type bool, offset -9]
...
;84:	 :=, Temp[$3, type bool, offset -4], -, $$
		...
		mov	si, word ptr [bp+6]
		mov	byte ptr [si], al
;85:	 Endu, Fun[prime, index 32, params 2, vars 10, nest 0, parent _outer], -, -
		mov	sp, bp
		pop	bp
		ret
_p_prime_32	endp
...
;114:	 call, -, -, Fun[print_string, index 5, params 0, vars 0, nest 0, parent _outer]
		...
		call	near ptr _print_string
		add	sp, 4
;115:	 :=, Var[counter, type int ref, offset -2, nest -1], -, Temp[$16, type int ref, offset -8]
		mov	ax, word ptr [bp-2]
		mov	word ptr [bp-8], ax
;116:	 par, [Temp[$16, type int ref, offset -8]], V, -
...
;117:	 call, -, -, Fun[print_int, index 1, params 0, vars 0, nest 0, parent _outer]
		...
		call	near ptr _print_int
		add	sp, 4
;118:	 par, " prime number(s) were found.
", V, -
